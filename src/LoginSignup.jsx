        ...
        <div className="flex justify-center items-center min-h-screen bg-slate-900 " >
            ...
            <div className='flex justify-center items-center'> <img src="https://axionfoam.com/axionlogo.png" alt="" className='w-36'/></div>
                ...
                <form action="" className='h-390 ' >
                    ...
                    <input
                        className="w-full mt-8 p-2 border border-gray-300 rounded-3xl pl-10"
                        type="email"
                    ...
                    <input
                        className="w-full mt-8 p-2 border border-gray-300 rounded-3xl"
                        type="password"
                    ...
                    <span className='items-center flex justify-center flex-col gap-4'>
                        ...
                        <button className=" w-32 mt-10  py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-3xl flex justify-center items-center gap-1" onClick={handleLogin}><CiLogin />Login</button>
