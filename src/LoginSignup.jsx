        ...
        <div className="flex justify-center items-center min-h-screen bg-slate-900 " >
            ...
            <div className='flex justify-center items-center'> <img src="https://axionfoam.com/axionlogo.png" alt="" className='w-36'/></div>
                ...
                <form action="" className='h-390 ' >
                    <h2 className=" flex justify-center items-center  text-6xl font-bold text-gray-800 mt-5 "> <RiAccountCircleFill /> </h2>
                    <span className='relative'>
                    <MdOutlineMailOutline className='absolute left-3 top-1/2 transform -translate-y-1/2'/>             
                    <input
                        className="w-full mt-8 p-2 border border-gray-300 rounded-md pl-10"
                        type="email"
                        placeholder="axion@gmail.com"
                        value={email}
                    ...
                    <input
                        className="w-full mt-8 p-2 border border-gray-300 rounded-md"
                        type="password"
                    ...
                    <span className='items-center flex justify-center flex-col gap-4'>
                        ...
                        <button className=" w-32 mt-5  py-2 bg-blue-500 hover:bg-blue-600 text-white rounded flex justify-center items-center gap-1" onClick={handleLogin}><CiLogin />Login</button>
                        {/* <p>Dont have an Account ?</p> */}
                        <button className="  w-32 p-1     bg-green-500 hover:bg-green-600 text-white rounded" onClick={handleSignup}>Sign Up</button>
                        {/* <p className='text-center text-sm mt-5'>Or Continue With</p>
                ...
                {/* <p className='text-center text-sm italic'> Admin Access Only.</p> */}
            </div>
        </div>
    );
}
